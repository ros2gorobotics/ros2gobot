...
| 11 | <img src="docs/parts/3dprint_battery_base.png" width="400"> | [OZUKA Battery Mount](https://github.com/ros2gorobotics/ros2gobot/blob/main/ros2gobot_hardware/printing_model/base_batt_up_v3.stl) | |  |
| 12 | <img src="docs/parts/switch24v.png" width="400"> | 24V Push On/Off Switch |  |  |
| 13 | <img src="docs/parts/terminal15a.png" width="400"> | TB-1508 Terminal Block |   |  |
| 14 | <img src="docs/parts/terminal_jumper.png" width="400"> | TB15xx Terminal jumper |  |  |
| 15 | <img src="docs/parts/pin_header.png" width="400"> | 2.54mm Single row straight pin header male connector | | |
| 16 | <img src="docs/parts/jumper_wire.png" width="400"> | Jumper Wire Kit, Female to Female |  |  |
| 17 | <img src="docs/parts/usb_screw.png" width="400"> | USB-C 2 Pin Power Only | |  |
| 18 | <img src="docs/parts/wires.png" width="400"> | Use 18 AWG red and black wires |  |  |
| 19 | <img src="docs/parts/caster_wheel.png" width="400"> | Swivel Caster Wheel 2.5 Inch | | - |
| 20 | <img src="docs/parts/sdcard.png" width="400"> | 64 GB MicroSD | | We recommend using a 64GB High Endurance microSD card for improved reliability and longer lifespan. |
| 21 | <img src="docs/parts/screws.jpg" width="400"> | Screw Kit |  | The kit contains everything you need. Check the [screw-table](#screw-table) for exact counts. |
