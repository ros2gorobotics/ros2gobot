...
| 9 | <img src="docs/parts/dc5v.png" width="400"> | 7-35V DC to DC 5V 5A | | Headers can be soldered freely, but matching the configuration in the picture is strongly advised. |
